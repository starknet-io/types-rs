...
pub struct Felt252Blake2s;

impl StarkHash for Felt252Blake2s {
...
mod tests {
    ...
    fn test_encode_felts_to_u32s_small() {
        ...
        let words = Felt252Blake2s::encode_felts_to_u32s(vec![val]);
    ...
    fn test_pack_224_le_to_felt_roundtrip() {
        ...
        let f = Felt252Blake2s::pack_224_le_to_felt(&buf);
    ...
    fn test_pack_224_le_to_felt_too_short() {
        ...
        Felt252Blake2s::pack_224_le_to_felt(&too_short);
    }
    ...
    fn test_hash_single_zero() {
        ...
        let hash = Felt252Blake2s::hash_single(&zero);
        let expected =
    ...
    fn test_hash_array_one_two() {
        ...
        let hash = Felt252Blake2s::hash_array(&[one, two]);
        let expected =
