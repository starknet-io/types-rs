...
use super::{BlockId, Felt, BroadcastedDeclareTxn, BroadcastedDeployAccountTxn, BroadcastedInvokeTxn};
use alloc::vec::Vec;
...
pub type EventAbiType = String /* event */;
...
pub struct ExecutionResources {
    ...
    pub steps: u64,
    pub data_availability: Anonymous,
}
...
pub type FunctionStateMutability = String /* view */;
...
pub type SimulationFlagForEstimateFee = String /* SKIP_VALIDATE */;
...
pub type StructAbiType = String /* struct */;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            where
                A: serde::de::SeqAccess<'de>,
            {
                let block_id: BlockId = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(1, &"expected 1 parameters"))?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            where
                A: serde::de::SeqAccess<'de>,
            {
                let contract_address: Address = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(1, &"expected 3 parameters"))?;
                let key: StorageKey = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(2, &"expected 3 parameters"))?;
                let block_id: BlockId = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(3, &"expected 3 parameters"))?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            where
                A: serde::de::SeqAccess<'de>,
            {
                let block_id: BlockId = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(1, &"expected 2 parameters"))?;
                let index: u64 = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(2, &"expected 2 parameters"))?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            where
                A: serde::de::SeqAccess<'de>,
            {
                let request: FunctionCall = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(1, &"expected 2 parameters"))?;
                let block_id: BlockId = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(2, &"expected 2 parameters"))?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            where
                A: serde::de::SeqAccess<'de>,
            {
                let request: Vec<BroadcastedTxn> = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(1, &"expected 3 parameters"))?;
                let simulation_flags: Vec<SimulationFlagForEstimateFee> = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(2, &"expected 3 parameters"))?;
                let block_id: BlockId = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(3, &"expected 3 parameters"))?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            where
                A: serde::de::SeqAccess<'de>,
            {
                let message: MsgFromL1 = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(1, &"expected 2 parameters"))?;
                let block_id: BlockId = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(2, &"expected 2 parameters"))?;
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for Visitor {
            ...
            where
                A: serde::de::SeqAccess<'de>,
            {
                let filter: EventFilterWithPageRequest = seq.next_element()?.ok_or_else(|| serde::de::Error::invalid_length(1, &"expected 1 parameters"))?;
